...
public:
    Square(ConcretePoint* tl, double length) {
        double x = tl->getX();
        double y = tl->getY();
        corners.push_back(new ConcretePoint(x, y));
        corners.push_back(new ConcretePoint(x + length, y));
        corners.push_back(new ConcretePoint(x + length, y - length));
        corners.push_back(new ConcretePoint(x, y - length));
    }
    void draw() const {
...
public:
    ...
    void draw() const {
        std::cout << "Drawing parallelogram: ";
        topLeft->draw();
        std::cout << " ";
        topRight->draw();
        std::cout << " ";
